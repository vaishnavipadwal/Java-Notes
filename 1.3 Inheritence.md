...
```
---
## **Program 1. Create a university management system using multilevel inheritance:**
...
```
---
## **Program2. Write a Java Program to demonstrate Hierarchical Inheritance**
...
public class HierarchicalInheritanceTest {
    public static void main(String[] args) {
        ...
        Truck truck1 = new Truck("Volvo", 120, 15);

        System.out.println("Car Details:");
        car1.displayDetails();   // Inherited from Vehicle class
        car1.carDetails();       // Specific to Car class

        System.out.println("\nTruck Details:");
        truck1.displayDetails(); // Inherited from Vehicle class
        truck1.truckDetails();   // Specific to Truck class
    }
}
```
### **Output**
...
```
---
## **Program 5. Write a java program to create interface Printable with a print() method. Implement this interface in Document and Image classes to display different types of printable content**
