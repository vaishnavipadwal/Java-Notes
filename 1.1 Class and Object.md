...
```
---
### Write a Java program to create Class Account with attributes AcNo, AcHolderName, and Amount Balance. Accept details for account holders and display it.
```
...
```
---
## **1. Write a Java program to create Class Account with attributes AcNo, AcHolderName, and Amount Balance. Accept details for account holders and display it.**
```
import java.util.Scanner;
...
## **2. Create a class Counter with: A static variable count to track the number of objects created. A constructor that increments count each time an object is created. A static method displayCount() to show the number of objects created.**
