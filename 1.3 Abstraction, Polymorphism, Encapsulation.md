...
---
### **Program 1. Write a java program to create interface Printable with a print() method. Implement this interface in Document and Image classes to display different types of printable content**
